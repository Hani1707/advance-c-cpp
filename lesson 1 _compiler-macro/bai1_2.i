...
int main()
{
    const char* items[] = {"Option 1", "Option 2", "Option 3","Option4", "Exit"}; int n = sizeof(items) / sizeof(items[0]); for (int i = 0; i < n; i++) { printf("%d. %s\n", i + 1, items[i]); };


    int option ;
    scanf("%d", &option);

    switch (option) { case 1: feature1(); break; case 2: feature2(); break; case 3: feature3(); break; case 4: feature4(); break; default: printf("Invalid option!\n"); }
